...
def show_chatConts_page():
    ...
    with col1:
        ...
        uploaded_file = st.file_uploader("上传PDF、DOC或TXT文件", type=["pdf", "doc", "docx", "txt"])
    ...
    with col2:
        ...
        if uploaded_content:
            ...
            if st.button("保存解析的内容",key="save_button_11"):
                ...
                file_name = f"{current_time}.txt" if isinstance(uploaded_content, str) else f"{current_time}.csv"
